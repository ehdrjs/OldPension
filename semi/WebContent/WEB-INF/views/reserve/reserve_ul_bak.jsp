	...
	<div class="reserve">
		...
		<form name="reserve_form1" method="post">
			...
			<div class="tb_basic_row">
				<ul>
					<li>체크인 날짜</li>
					<li><input type="date" id="startDay" name="startDay"></li>
					
				</ul>
				<ul>
					<li>체크아웃 날짜</li>
					<li><input type="date" id="endDay" name="endDay"></li>
			...
			<p class="mt10 mb10">예약자 정보</p>
				<div class="tb_basic_row">
					<ul>
						<li>예약자 이름 <input type="text" name="reserve_name"></li>
						<li>비밀번호 <input type="password" name="reserve_pwd"></li>
					</ul>
					<ul>
						<li>연락처 <input type="text" name="reserve_tel"></li>
						<li>입금 은행</li>
						<li>
							<select id="bank">
								<option value="">선택</option>
					...
					<ul>
						<li>요청사항</li>
						<li><textarea name="reserve_textarea" style="width:100%"></textarea></li>
					</ul>
				</div>
